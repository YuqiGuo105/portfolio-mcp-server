...
const OWNER_ONLY_TOOLS = new Set([
  ...
  'career.record_application_review',
  'career.record_application_fill',
  'career.record_submission_receipt',
  'career.confirm_application_submission',
  'career.update_private_answers',
  'career.update_memory',
  'career.get_site_credential',
  'career.prepare_site_credential',
  'career.list_private_resumes',
  'career.get_private_resume',
  'career.create_private_resume',
  'career.update_private_resume',
  'career.delete_private_resume',
  'career.get_private_answers',
  'career.upsert_private_answer',
  'career.delete_private_answer',
  'career.list_resume_assets',
  'career.get_active_resume_asset',
  'career.prepare_resume_upload',
  'career.complete_resume_upload',
  'career.activate_resume_asset',
  'resume.activate_version',
  'career.get_active_resume_download',
  'resume.get_current',
  'resume.list_versions',
  'resume.get_version',
  'resume.create_revision',
  'resume.update_draft',
  'resume.publish_revision',
  'resume.rollback_revision',
  'resume.delete_draft',
]);
